...
#define kLetfBtnHightLighColor [UIColor LJUserManagerBgColor]
#define kRightBtnDefaultColor [UIColor whiteColor]
#define kRightBtnHightLighColor [UIColor LJUserManagerBgColor]
...
//    }
    ...
    [rightBtn setTitleColor:[UIColor LJSkyBlueColor] forState:(UIControlStateNormal)] ;
