...
#define effectDuration 1.0 //  细化效果维持多少秒
...
+ (void)_basicWithMessage:(NSString *)message
      ...
      inView : (UIView *)view
{
    [self _basicWithMessage:message duration:duration Type:type subType:subType inView:view];
...
//        [self transitionWithDuration:duration Type:type WithSubtype:subType ForView:label];
        ...
        [UIView animateWithDuration:duration delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
            ...
            [self removeAllofLabel];
            [self removeAllsAnimation];
...
+ (void)show:(NSString *)message;
{
    ...
    [self _basicWithMessage:message duration:effectDuration Type:@"rippleEffect" subType:kCATransitionFromLeft inView:nil];
}
// 默认的水晶紫
...
+ (void)showFade:(NSString *)message{
    ...
    [self _basicWithMessage:message duration:effectDuration Type:kCATransitionFade subType:kCATransitionFromTop inView:nil];
}

// 相机
+ (void)showKaca:(NSString *)message
{
    [self _basicWithMessage:message labelTextColor:[UIColor whiteColor] labelBgColor:[UIColor blackColor] duration:effectDuration Type:@"cameraIrisHollowClose" subType:kCATransitionFromLeft inView:nil];
}

// 庆祝
+ (void)showCongratulate:(NSString *)message
{
    [self _basicWithMessage:message labelTextColor:[UIColor redColor] labelBgColor:MiColor(255, 29, 139) duration:effectDuration Type:@"oglFlip" subType:kCATransitionFromBottom inView:nil];
}
